...
/**
 * {@link FactoryBean} that creates an
 * iBATIS {@link SqlMapClient}. This is the usual
...
public class SqlMapClientFactoryBean implements FactoryBean<SqlMapClient>, InitializingBean {
	 ...
	 * @see #setConfigLocation
	 * @see SqlMapClientBuilder#buildSqlMapClient(InputStream, Properties)
	 */
	 ...
	 * @see SqlMapClientBuilder#buildSqlMapClient
	 */
