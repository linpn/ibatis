...
public interface SqlMapClientOperations {
	 ...
	 * @throws DataAccessException in case of errors
	 */
	<T> T queryForObject(String statementName, Object parameterObject)
	 ...
	 * @throws DataAccessException in case of errors
	 */
	<T> T queryForObject(String statementName, Object parameterObject, Object resultObject)
			throws DataAccessException;
	 ...
	 * @throws DataAccessException in case of errors
	 */
	<T> List<T> queryForList(String statementName, Object parameterObject)
			throws DataAccessException;
	 ...
	 * @throws DataAccessException in case of errors
	 */
	<T> List<T> queryForList(String statementName, int skipResults, int maxResults)
			throws DataAccessException;
