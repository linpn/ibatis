 ...
 * {@link SqlMapClient} API, converting checked
...
public class SqlMapClientTemplate extends JdbcAccessor implements SqlMapClientOperations {
    ...
    public <T> T queryForObject(final String statementName, final Object parameterObject)
        ...
        return (T) execute(new SqlMapClientCallback<Object>() {
            public Object doInSqlMapClient(SqlMapExecutor executor) throws SQLException {
    ...
    public <K, V> Map<K, V> queryForMap(
    ...
    public <T> T insert(final String statementName, final Object parameterObject)
            throws DataAccessException {
        return (T) execute(new SqlMapClientCallback<Object>() {
            public Object doInSqlMapClient(SqlMapExecutor executor) throws SQLException {
