...
//                .get(InternalAttribute.ATTR_IBATIS2_SQL_MAP_FILE_NAME);
        return this.getIbatis2SqlMapNamespace() + ".sqlmap.xml";  //Linpn修改
    }
...
//        }
//        return namespace;
        return this.getIbatis2SqlMapNamespace(); //Linpn修改
    }
...
//                .get(InternalAttribute.ATTR_UPDATE_BY_PRIMARY_KEY_SELECTIVE_STATEMENT_ID);
        return "edit" + fullyQualifiedTable.getDomainObjectName(); //Linpn修改
    }
...
//                .get(InternalAttribute.ATTR_SELECT_BY_PRIMARY_KEY_STATEMENT_ID);
        return "get" + fullyQualifiedTable.getDomainObjectName(); //Linpn修改
    }
...
//                .get(InternalAttribute.ATTR_INSERT_SELECTIVE_STATEMENT_ID);
        return "add" + fullyQualifiedTable.getDomainObjectName(); //Linpn修改
    }
...
//                .get(InternalAttribute.ATTR_DELETE_BY_PRIMARY_KEY_STATEMENT_ID);
        return "del" + fullyQualifiedTable.getDomainObjectName(); //Linpn修改
    }
...
//                .get(InternalAttribute.ATTR_MYBATIS3_XML_MAPPER_FILE_NAME);
        return this.getMyBatis3SqlMapNamespace() + ".mapper.xml";  //Linpn修改
    }
