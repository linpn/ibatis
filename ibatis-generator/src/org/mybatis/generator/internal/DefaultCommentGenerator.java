...
//        innerClass .addJavaDocLine(" * This class was generated by MyBatis Generator."); //$NON-NLS-1$  //Linpn修改
...
//        innerEnum.addJavaDocLine(" * This enum was generated by MyBatis Generator."); //$NON-NLS-1$  //Linpn修改
...
//        addJavadocTag(innerEnum, false);
    ...
    public void addFieldComment(Field field,
        ...
        field.addJavaDocLine(" * " + introspectedColumn.getRemarks()); //$NON-NLS-1$ //$NON-NLS-1$ //Linpn修改

        sb.append(" * Table column "); //$NON-NLS-1$
        sb.append(introspectedTable.getFullyQualifiedTable());
        sb.append('.');
